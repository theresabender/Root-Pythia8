...
//                    daughterList = event->at(iparticle).daughterList(iparticle);
                    ...
                    if (daughterList.size() >0){
                        cout << "Daughter[0] index: " << daughterList.at(0) << endl;
                        }
                    }
...
//        vector<Int_t> daughters = event[i].daughterList(i);
//        if (daughters.size()){
//            cout << "event #" << i << " daughter[0]"<< daughters.at(0) << endl;
//        } else {
//            cout << "event #" << i << " no daughters"<< endl;
//        }
    } // end of event cycle
